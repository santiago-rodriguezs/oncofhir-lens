...
const SOURCE_COLORS: Record<string, string> = {
  OncoKB: 'bg-emerald-100 text-emerald-800 border-emerald-300',
  ClinVar: 'bg-blue-100 text-blue-800 border-blue-300',
  CIViC: 'bg-purple-100 text-purple-800 border-purple-300',
  PharmGKB: 'bg-amber-100 text-amber-800 border-amber-300',
  DGIdb: 'bg-cyan-100 text-cyan-800 border-cyan-300',
  gnomAD: 'bg-orange-100 text-orange-800 border-orange-300',
  COSMIC: 'bg-pink-100 text-pink-800 border-pink-300',
